    ...
    >
      ...
      <Container>
        <div className="py-14 flex items-center gap-2 relative">
          ...
          {/* vertical divider */}
          <div className="w-px h-32 bg-linear-to-b from-transparent via-orange-300 to-transparent self-center mx-6 shrink-0" />
          ...
          <div className="max-w-145">
            ...
            <h3 className="text-6xl text-zinc-800 font-black leading-tight tracking-tight">
              First Order <span className="text-orange-500">Discount!</span>
            </h3>

            <p className="text-zinc-500 my-5 text-sm leading-relaxed max-w-md">
