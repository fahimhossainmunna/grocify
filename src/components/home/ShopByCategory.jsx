      ...
      <section className="sbc-root" style={{ padding: "96px 24px", background: "#fafafa" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 24, marginBottom: 52, flexWrap: "wrap" }}>
            ...
            <button className="sbc-shop-all" onClick={() => navigate("/shop")}>
          ...
          <div className="sbc-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 20 }}>
            {CATEGORIES.map((cat) => (
              ...
              >
                ...
                {/* Emoji strip */}
                <div className="sbc-emoji-strip" style={{ fontSize: 28, letterSpacing: 4, marginBottom: 20, display: "block" }}>
                  {cat.img}
                </div>
                ...
                <div style={{
                  ...
                  fontSize: 28,
                  boxShadow: `0 4px 16px ${cat.accent}22`,
                  marginBottom: 18,
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "auto", paddingTop: 16, borderTop: `1px solid ${cat.border}` }}>
                  <span style={{
                    ...
                    color: cat.accent, letterSpacing: "0.06em",
                    background: "#fff",
          ...
          <div style={{
            ...
            <button className="sbc-shop-all" onClick={() => navigate("/shop")}
              style={{ background: "#f97316", padding: "11px 24px", fontSize: 13 }}>
              Shop Now →
            </button>
          </div>
